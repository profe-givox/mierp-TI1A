...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('crm', '0002_rename_user_userpublic_alter_chatmessage_sender_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chat_messages', to='crm.chatgroup')),
            ],
            options={
                'ordering': ['-created'],
            },
